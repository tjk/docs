      ...
      return {
        doc: {
          ...
          examples: [
            ...
            { header: 'Popover menu', file: 'menus/popover', desc: 'A menu can be configured to be static when opened, allowing it to function as a popover. This can be useful when there are multiple interactable items within the menu contents.' }
          ],
          props: {
            'v-menu': {
