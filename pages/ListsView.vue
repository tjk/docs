      ...
      return {
        doc: {
          ...
          examples: [
            ...
            { header: 'Expansion Lists', file: 'lists/10', desc: `A list can contain a group of items which will display on click. Expansion lists are also used within the <code>navigation drawer</code> component.` },
