      ...
      return {
        doc: {
          ...
          examples: [
            ...
            { header: "Month pickers - Custom format", file: "pickers/month-custom-format", desc: 'You can specify a custom month format. This will be returned through the <code>formatted-value</code> prop. Using the sync property (new in Vue 2.3), you can link up a formatted version of the month.'},
